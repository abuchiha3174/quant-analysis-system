...
When `LANGCHAIN_TRACING_V2=true` is set, every agent step, tool call, and LLM interaction is traced in **LangSmith**. This lets you debug exactly what each agent did, what tools it called, and what the LLM reasoned at each step.# 📈 CrewAI Financial Analyst
